...
public class UserInfoAdapter extends RecyclerView.Adapter<UserInfoAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (userInfo.isFlag()){
            holder.userInfoView.setBackgroundColor(Color.parseColor("#e8e8e8"));
        }else{
        ...
        if (userInfo.getStatus() == 0){
            ...
            holder.nameTextView.setTextColor(Color.parseColor("#008000"));
            holder.statusTextView.setTextColor(Color.parseColor("#008000"));
        }
